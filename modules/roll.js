  ...
  switch(color) {
      case "blue":
        ...
        switch (number) {
          case 1:
            ...
            diceResult[channel].face += print("b: Blank", message);
            break;
          case 2:
            console.log(chalk.white.bgBlue("Blank"));
            diceResult[channel].face += print("b: Blank", message);
          ...
          case 3:
            ...
            diceResult[channel].success += 1;
            diceResult[channel].face += print("b: Success", message);
            break;
          case 4:
            console.log(chalk.white.bgBlue("Advantage"));
            diceResult[channel].advantage += 1;
            diceResult[channel].face += print("b: Advantage", message);
            break;
          case 5:
            console.log(chalk.white.bgBlue("Advantage x2"));
            diceResult[channel].advantage += 2;
            diceResult[channel].face += print("b: Advantage x2", message);
            break;
          case 6:
            console.log(chalk.white.bgBlue("Success + Advantage"));
            diceResult[channel].success += 1;
            diceResult[channel].advantage += 1;
            diceResult[channel].face += print("b: Success + Advantage", message);
            break;
        }
        break;
      case "green":
        ...
        switch (number) {
          case 1:
            ...
            diceResult[channel].face += print("g: Blank", message);
            break;
          case 2:
            console.log(chalk.white.bgGreen("Success"));
            diceResult[channel].face += print("g: Success", message);
            diceResult[channel].success += 1;
            break;
          case 3:
            console.log(chalk.white.bgGreen("Success"));
          ...
          case 4:
            ...
            diceResult[channel].face += print("g: Advantage", message);
            diceResult[channel].advantage += 1;
            break;
          case 5:
            console.log(chalk.white.bgGreen("Advantage"));
          ...
          case 6:
            ...
            diceResult[channel].face += print("g: Success + Advantage", message);
            diceResult[channel].success += 1;
            diceResult[channel].advantage += 1;
            break;
          case 7:
            console.log(chalk.white.bgGreen("Advantage x2"));
            diceResult[channel].face += print("g: Advantage x2", message);
            diceResult[channel].advantage += 2;
            break;
          case 8:
            console.log(chalk.white.bgGreen("Success x2"));
            diceResult[channel].face += print("g: Success x2", message);
      ...
      case "yellow":
        ...
        switch (number) {
          case 1:
            ...
            diceResult[channel].face += print("y: Blank", message);
            break;
          case 2:
            console.log(chalk.black.bgYellow("Success"));
            diceResult[channel].success += 1;
            diceResult[channel].face += print("y: Success", message);
            break;
          case 3:
            console.log(chalk.black.bgYellow("Success"));
            diceResult[channel].success += 1;
          ...
          case 4:
            ...
            diceResult[channel].success += 2;
            diceResult[channel].face += print("y: Success x2", message);
            break;
          case 5:
            console.log(chalk.black.bgYellow("Success x2"));
            diceResult[channel].success += 2;
          ...
          case 6:
            ...
            diceResult[channel].advantage += 1;
            diceResult[channel].face += print("y: Advantage", message);
            break;
          case 7:
            console.log(chalk.black.bgYellow("Success + Advantage"));
            diceResult[channel].success += 1;
            diceResult[channel].advantage += 1;
            diceResult[channel].face += print("y: Success + Advantage", message);
            break;
          case 8:
            console.log(chalk.black.bgYellow("Success + Advantage"));
            diceResult[channel].success += 1;
          ...
          case 10:
            ...
            diceResult[channel].advantage += 2;
            diceResult[channel].face += print("y: Advantage x2", message);
            break;
          case 11:
            console.log(chalk.black.bgYellow("Advantage x2"));
            diceResult[channel].advantage += 2;
          ...
          case 12:
            ...
            diceResult[channel].triumph += 1;
            diceResult[channel].success += 1;
            diceResult[channel].face += print("y: Triumph", message);
            break;
        }
        break;
      case "black":
        ...
        switch (number) {
          case 1:
            ...
            diceResult[channel].face += print("s: Blank", message);
            break;
          case 2:
            console.log(chalk.white.bgBlack("Blank"));
            diceResult[channel].face += print("s: Blank", message);
          ...
          case 3:
            ...
            diceResult[channel].failure += 1;
            diceResult[channel].face += print("s: Failure", message);
            break;
          case 4:
            console.log(chalk.white.bgBlack("Failure"));
            diceResult[channel].failure += 1;
          ...
          case 5:
            ...
            diceResult[channel].threat += 1;
            diceResult[channel].face += print("s: Threat", message);
            break;
          case 6:
            console.log(chalk.white.bgBlack("Threat"));
            diceResult[channel].threat += 1;
      ...
      case "purple":
        ...
        switch (number) {
          case 1:
            ...
            diceResult[channel].face += print("p: Blank", message);
            break;
          case 2:
            console.log(chalk.white.bgMagenta("Failure"));
            diceResult[channel].failure += 1;
            diceResult[channel].face += print("p: Failure", message);
            break;
          case 3:
            console.log(chalk.white.bgMagenta("Failure x2"));
            diceResult[channel].failure += 2;
            diceResult[channel].face += print("p: Failure x2", message);
            break;
          case 4:
            console.log(chalk.white.bgMagenta("Threat"));
            diceResult[channel].threat += 1;
            diceResult[channel].face += print("p: Threat", message);
            break;
          case 5:
            console.log(chalk.white.bgMagenta("Threat"));
            diceResult[channel].threat += 1;
          ...
          case 7:
            ...
            diceResult[channel].face += print("p: Threat x2", message);
            break;
          case 8:
            console.log(chalk.white.bgMagenta("Failure + Threat"));
            diceResult[channel].failure += 1;
            diceResult[channel].threat += 1;
            diceResult[channel].face += print("p: Failure + Threat", message);
            break;
        }
        break;
      case "red":
        ...
        switch (number) {
          case 1:
            ...
            diceResult[channel].face += print("r: Blank", message);
            break;
          case 2:
            console.log(chalk.black.bgRed("Despair"));
            diceResult[channel].despair += 1;
            diceResult[channel].failure += 1;
            diceResult[channel].face += print("r: Despair", message);
            break;
          case 3:
            console.log(chalk.black.bgRed("Failure"));
            diceResult[channel].failure += 1;
            diceResult[channel].face += print("r: Failure", message);
            break;
          case 4:
            console.log(chalk.black.bgRed("Failure"));
            diceResult[channel].failure += 1;
          ...
          case 5:
            ...
            diceResult[channel].threat += 1;
            diceResult[channel].face += print("r: Threat", message);
            break;
          case 6:
            console.log(chalk.black.bgRed("Threat"));
            diceResult[channel].threat += 1;
          ...
          case 7:
            ...
            diceResult[channel].failure += 2;
            diceResult[channel].face += print("r: Failure x2", message);
            break;
          case 8:
            console.log(chalk.black.bgRed("Failure x2"));
            diceResult[channel].failure += 2;
          ...
          case 9:
            ...
            diceResult[channel].threat += 2;
            diceResult[channel].face += print("r: Threat x2", message);
            break;
          case 10:
            console.log(chalk.black.bgRed("Threat x2"));
            diceResult[channel].threat += 2;
          ...
          case 11:
            ...
            diceResult[channel].failure += 1;
            diceResult[channel].threat += 1;
            diceResult[channel].face += print("r: Failure + Threat", message);
            break;
          case 12:
            console.log(chalk.black.bgRed("Failure + Threat"));
            diceResult[channel].failure += 1;
      ...
      case "white":
        ...
        case 1:
          ...
          diceResult[channel].light += 1;
          diceResult[channel].face += print("w: Light", message);
          break;
        case 2:
          console.log(chalk.black.bgWhite("Light"));
          diceResult[channel].light += 1;
        ...
        case 3:
          ...
          diceResult[channel].face += print("w: Light x2", message);
          break;
        case 4:
          console.log(chalk.black.bgWhite("Light x2"));
          diceResult[channel].light += 2;
        ...
        case 6:
          ...
          diceResult[channel].dark += 1;
          diceResult[channel].face += print("w: Dark", message);
          break;
        case 7:
          console.log(chalk.black.bgWhite("Dark"));
          diceResult[channel].dark += 1;
        ...
        case 12:
          ...
          diceResult[channel].face += print("w: Dark x2", message);
          break;
        }
        break;
      }
